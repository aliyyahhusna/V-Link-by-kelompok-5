...
// ==========================================
// 2. KUMPULAN FUNGSI VALIDASI & UTALITAS
// ==========================================
...
// Validasi BNSP Nomor Sertifikat Atas (Format: Angka Angka Angka Tahun)
...
int validate_ijazah_kuliah(const char *id) {
...
// ==========================================
// 3. LOGIC ENGINE, SORTING & POINTERS
// ==========================================
...
// ==========================================
// 4. FUNGSI INPUT DATA RELAWAN & PROYEK
// ==========================================
    ...
    for (int i = 0; i < r->jumlahSkill; i++) {
        ...
        if (r->levelSkill[i] > UNCERTIFIED) {
            ...
            switch (r->sertif[i].platformOpsi) {
                ...
                case 6: strcpy(r->sertif[i].platformNama, "Ijazah Kuliah"); valid = validate_ijazah_kuliah(input_cert); break; 
...
// ==========================================
// 5. MATCHMAKING & DASHBOARD SYSTEM
// ==========================================
